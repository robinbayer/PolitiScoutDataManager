...
namespace Overthink.PolitiScout
{
    public class ApplicationValues
    {
        ...
        public static int PERSON_SEARCH_QUERY_RESULT_COLUMN_OFFSET_PERSON_ID = 0;
        public static int PERSON_SEARCH_QUERY_RESULT_COLUMN_OFFSET_LAST_NAME = 1;
        public static int PERSON_SEARCH_QUERY_RESULT_COLUMN_OFFSET_FIRST_NAME = 2;
        public static int PERSON_SEARCH_QUERY_RESULT_COLUMN_OFFSET_MIDDLE_NAME = 3;
        public static int PERSON_SEARCH_QUERY_RESULT_COLUMN_OFFSET_GENERATION_SUFFIX = 4;
        public static int PERSON_SEARCH_QUERY_RESULT_COLUMN_OFFSET_PREFERRED_FIRST_NAME = 5;
        public static int PERSON_SEARCH_QUERY_RESULT_COLUMN_OFFSET_DATE_OF_BIRTH = 6;
